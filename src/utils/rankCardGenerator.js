 ...
 * Generates a beautiful rank card image buffer using a custom premium layout.
 */
async function generateRankCard({ username, level, currentXp, nextLevelXp, rank, avatarUrl, showPfp = true, bgColor = '#111217', accentColor = '#7c3aed', borderColor = '#23252e' }) {
    let avatarBase64 = '';
    ...
    <svg width="800" height="220" viewBox="0 0 800 220" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect width="800" height="220" rx="16" fill="${bgColor}" />
        
        <!-- Subtle clean card border -->
        <rect x="0.75" y="0.75" width="798.5" height="218.5" rx="15.25" fill="none" stroke="${borderColor}" stroke-width="1.5" />
        ...
        <rect x="640" y="35" width="120" height="36" rx="18" fill="${bgColor}" stroke="${borderColor}" stroke-width="1.5" />
        ...
        <rect x="190" y="145" width="440" height="24" rx="12" fill="${bgColor}" stroke="${borderColor}" stroke-width="1" />
        <!-- Progress fill -->
